...
#ifndef mitkGizmoInteractorCylinder_h
#define mitkGizmoInteractorCylinder_h
...
namespace mitk
{
  ...
  //!
  //! \sa Gizmo
  class MITKGIZMO_EXPORT GizmoInteractorCylinder : public DataInteractor
  {
  public:
    mitkClassMacro(GizmoInteractorCylinder, DataInteractor);
    ...
    //! Set initial transformation axes to be transformed by changes in geometry
    void SetInitialAxes(Vector3D axisX, Vector3D axisY, Vector3D axisZ);

  private:
    GizmoInteractorCylinder();
    ~GizmoInteractorCylinder() override;
    ...
    Vector3D m_initialAxisX;  //initial transformation axis (rotation, translation) modified by changes in geometry
    Vector3D m_initialAxisY;
    Vector3D m_initialAxisZ;
