...
mitk::GizmoInteractorCylinder::GizmoInteractorCylinder()
{
    ...
    m_initialAxisX.Fill(0);
    m_initialAxisX[0] = 1;
    m_initialAxisY.Fill(0);
    m_initialAxisY[1] = 1;
    m_initialAxisZ.Fill(0);
    m_initialAxisZ[2] = 1;
...
void mitk::GizmoInteractorCylinder::SetInitialAxes(Vector3D axisX, Vector3D axisY, Vector3D axisZ)
{
    m_initialAxisX = axisX;
    m_initialAxisY = axisY;
    m_initialAxisZ = axisZ;
}

void mitk::GizmoInteractorCylinder::ConnectActionsAndFunctions()
{
...
void mitk::GizmoInteractorCylinder::SetGizmoNode(DataNode *node)
{
...
void mitk::GizmoInteractorCylinder::SetManipulatedObjectNode(DataNode *node)
{
...
bool mitk::GizmoInteractorCylinder::HasPickedHandle(const InteractionEvent *interactionEvent)
{
...
void mitk::GizmoInteractorCylinder::DecideInteraction(StateMachineAction *, InteractionEvent *interactionEvent)
{
  ...
  mitk::AffineTransform3D *affine = m_ManipulatedObjectGeometry->GetIndexToWorldTransform();

  switch ( m_PickedHandle ) {
  case Gizmo::MoveAlongAxisX:
  case Gizmo::RotateAroundAxisX:
  case Gizmo::ScaleX:
      m_AxisOfMovement = affine->TransformVector(m_initialAxisX);
      break;
  case Gizmo::MoveAlongAxisY:
  case Gizmo::RotateAroundAxisY:
  case Gizmo::ScaleY:
      m_AxisOfMovement = affine->TransformVector(m_initialAxisY);
      break;
  case Gizmo::MoveAlongAxisZ:
  case Gizmo::RotateAroundAxisZ:
  case Gizmo::ScaleZ:
      m_AxisOfMovement = affine->TransformVector(m_initialAxisZ);
      break;
  default:
      break;
  }
...
void mitk::GizmoInteractorCylinder::MoveAlongAxis(StateMachineAction *, InteractionEvent *interactionEvent)
{
  auto positionEvent = dynamic_cast<const InteractionPositionEvent *>(interactionEvent);
  if (positionEvent == nullptr)
  {
...
void mitk::GizmoInteractorCylinder::RotateAroundAxis(StateMachineAction *, InteractionEvent *interactionEvent)
{
  auto positionEvent = dynamic_cast<const InteractionPositionEvent *>(interactionEvent);
  if (positionEvent == nullptr)
  {
...
void mitk::GizmoInteractorCylinder::MoveFreely(StateMachineAction *, InteractionEvent *interactionEvent)
{
  auto positionEvent = dynamic_cast<const InteractionPositionEvent *>(interactionEvent);
  if (positionEvent == nullptr)
  {
...
void mitk::GizmoInteractorCylinder::ScaleEqually(StateMachineAction *, InteractionEvent *interactionEvent)
{
  auto positionEvent = dynamic_cast<const InteractionPositionEvent *>(interactionEvent);
  if (positionEvent == nullptr)
  {
...
void mitk::GizmoInteractorCylinder::ApplyTranslationToManipulatedObject(const Vector3D &translation)
{
...
void mitk::GizmoInteractorCylinder::ApplyEqualScalingToManipulatedObject(double scalingFactor)
{
  assert(m_ManipulatedObjectGeometry.IsNotNull());
  auto manipulatedGeometry = m_InitialManipulatedObjectGeometry->Clone();
...
void mitk::GizmoInteractorCylinder::ApplyRotationToManipulatedObject(double angle_deg)
{
  assert(m_ManipulatedObjectGeometry.IsNotNull());
...
void mitk::GizmoInteractorCylinder::FeedUndoStack(StateMachineAction *, InteractionEvent *)
{
  if (m_UndoEnabled)
  {
...
mitk::Gizmo::HandleType mitk::GizmoInteractorCylinder::PickFrom2D(const InteractionPositionEvent *positionEvent)
{
...
mitk::Gizmo::HandleType mitk::GizmoInteractorCylinder::PickFrom3D(const InteractionPositionEvent *positionEvent)
{
  BaseRenderer *renderer = positionEvent->GetSender();
  auto &picker = m_Picker[renderer];
  if (picker == nullptr)
...
void mitk::GizmoInteractorCylinder::UpdateHandleHighlight()
{
